...
class ContentNodeIterator(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ContentNodeIterator, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ContentNodeIterator, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _PDFNetPython.new_ContentNodeIterator(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_setmethods__["mp_impl"] = _PDFNetPython.ContentNodeIterator_mp_impl_set
    __swig_getmethods__["mp_impl"] = _PDFNetPython.ContentNodeIterator_mp_impl_get
    if _newclass:
        mp_impl = _swig_property(_PDFNetPython.ContentNodeIterator_mp_impl_get, _PDFNetPython.ContentNodeIterator_mp_impl_set)
ContentNodeIterator_swigregister = _PDFNetPython.ContentNodeIterator_swigregister
ContentNodeIterator_swigregister(ContentNodeIterator)
...
class OutputOptionsOCR(_object):
    ...
    if _newclass:
        PreferredOCRChoiceToString = staticmethod(_PDFNetPython.OutputOptionsOCR_PreferredOCRChoiceToString)
    else:
        PreferredOCRChoiceToString = _PDFNetPython.OutputOptionsOCR_PreferredOCRChoiceToString
...
OutputOptionsOCR_PreferredOCRChoiceToString = _PDFNetPython.OutputOptionsOCR_PreferredOCRChoiceToString
...
class TextStyledElement(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, TextStyledElement, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, TextStyledElement, name)
    ...
    __swig_setmethods__["m_impl"] = _PDFNetPython.TextStyledElement_m_impl_set
    __swig_getmethods__["m_impl"] = _PDFNetPython.TextStyledElement_m_impl_get
    if _newclass:
        m_impl = _swig_property(_PDFNetPython.TextStyledElement_m_impl_get, _PDFNetPython.TextStyledElement_m_impl_set)
    __swig_destroy__ = _PDFNetPython.delete_TextStyledElement
    __del__ = lambda self: None
TextStyledElement_swigregister = _PDFNetPython.TextStyledElement_swigregister
TextStyledElement_swigregister(TextStyledElement)

class ContentElement(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ContentElement, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ContentElement, name)
    ...
    __swig_setmethods__["m_impl"] = _PDFNetPython.ContentElement_m_impl_set
    __swig_getmethods__["m_impl"] = _PDFNetPython.ContentElement_m_impl_get
    if _newclass:
        m_impl = _swig_property(_PDFNetPython.ContentElement_m_impl_get, _PDFNetPython.ContentElement_m_impl_set)
ContentElement_swigregister = _PDFNetPython.ContentElement_swigregister
ContentElement_swigregister(ContentElement)

class TextRun(ContentElement):
    __swig_setmethods__ = {}
    for _s in [ContentElement]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, TextRun, name, value)
    __swig_getmethods__ = {}
    for _s in [ContentElement]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, TextRun, name)
...
TextRun_swigregister = _PDFNetPython.TextRun_swigregister
TextRun_swigregister(TextRun)

class ContentNode(ContentElement):
    __swig_setmethods__ = {}
    for _s in [ContentElement]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ContentNode, name, value)
    __swig_getmethods__ = {}
    for _s in [ContentElement]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ContentNode, name)
...
ContentNode_swigregister = _PDFNetPython.ContentNode_swigregister
ContentNode_swigregister(ContentNode)

class Paragraph(ContentNode):
    __swig_setmethods__ = {}
    for _s in [ContentNode]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
...
Paragraph_swigregister = _PDFNetPython.Paragraph_swigregister
...
class TableCell(ContentNode):
    ...
    for _s in [ContentNode]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, TableCell, name, value)
    __swig_getmethods__ = {}
    for _s in [ContentNode]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, TableCell, name)
...
TableCell_swigregister = _PDFNetPython.TableCell_swigregister
TableCell_swigregister(TableCell)
...
TableRow_swigregister = _PDFNetPython.TableRow_swigregister
...
Table_swigregister = _PDFNetPython.Table_swigregister
...
class List(ContentNode):
    ...
    __swig_setmethods__["m_impl"] = _PDFNetPython.List_m_impl_set
    __swig_getmethods__["m_impl"] = _PDFNetPython.List_m_impl_get
    if _newclass:
        m_impl = _swig_property(_PDFNetPython.List_m_impl_get, _PDFNetPython.List_m_impl_set)
List_swigregister = _PDFNetPython.List_swigregister
...
class ListItem(ContentNode):
    ...
    __swig_setmethods__["m_impl"] = _PDFNetPython.ListItem_m_impl_set
    __swig_getmethods__["m_impl"] = _PDFNetPython.ListItem_m_impl_get
    if _newclass:
        m_impl = _swig_property(_PDFNetPython.ListItem_m_impl_get, _PDFNetPython.ListItem_m_impl_set)
ListItem_swigregister = _PDFNetPython.ListItem_swigregister
ListItem_swigregister(ListItem)

class FlowDocument(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, FlowDocument, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, FlowDocument, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _PDFNetPython.new_FlowDocument()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __swig_setmethods__["m_impl"] = _PDFNetPython.FlowDocument_m_impl_set
    __swig_getmethods__["m_impl"] = _PDFNetPython.FlowDocument_m_impl_get
    if _newclass:
        m_impl = _swig_property(_PDFNetPython.FlowDocument_m_impl_get, _PDFNetPython.FlowDocument_m_impl_set)
FlowDocument_swigregister = _PDFNetPython.FlowDocument_swigregister
FlowDocument_swigregister(FlowDocument)
